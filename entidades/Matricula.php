...
class Matricula extends Entidad
{
	...
	public function bindValues($statement)
	{
		...
		$statement->bindValue(5, $this->cuotasMatricula, PDO::PARAM_INT);
		$statement->bindValue(6, $this->costoOriginalMatricula, PDO::PARAM_STR);
		$statement->bindValue(7, $this->descuentoMatricula, PDO::PARAM_STR);
		$statement->bindValue(8, $this->promocionMatricula, PDO::PARAM_STR);
		$statement->bindValue(9, $this->costoFinalMatricula, PDO::PARAM_STR);
		...
		$statement->bindValue(12, $this->estadoMatricula, PDO::PARAM_STR);
		$statement->bindValue(13, $this->idEstudiante, PDO::PARAM_INT);
		$statement->bindValue(14, $this->opcion, PDO::PARAM_INT);
		$statement->bindValue(15, $this->pagina, PDO::PARAM_INT);
		return $statement;
	}
