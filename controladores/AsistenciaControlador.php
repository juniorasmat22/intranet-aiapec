...
class AsistenciaControlador extends Controlador
{
	...
	public function index(){
		...
		$reporteAsistencia->entidad->setMetodoPost();
		$reporteAsistencia->entidad->fechaInicio= isset($reporteAsistencia->entidad->fechaInicio)?$reporteAsistencia->entidad->fechaInicio:'2023-08-08';//2023-10-23';
