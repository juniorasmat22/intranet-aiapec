...
?>
<form class="needs-validation" novalidate action="?c=estudiantepre&a=editar" method="post" id="formEditar">
    <input type="hidden" name="idPre" name="idPre">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="position-relative mb-3">
                ...
                <select class="form-select" id="idAreaEditar" name="idArea" required onchange="llenar_carreras(2)">
        ...
        <div class="col-md-6">
            <div class="position-relative mb-3">
                ...
                <select id="idCarreraEditar" name="idCarrera" required class="form-select">
