...
?>
<form class="needs-validation" novalidate action="?c=estudianteescolar&a=crear" method="post" id="formCrear">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select required class="form-control " onchange="llenar_grados(1)" name="idNivel" id="idNivel" >
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select required class="form-control" name="idGrado" id="idGrado" >
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select required onchange="mostrar_solo_colegio()" class="form-control " name="colegioEscolar" id="colegioEscolar" >
                    <option selected disabled>Seleccione una opción</option>
    ...
    <div class="row" id="solo_colegio_aiapaec" style="display: none;">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select required class="form-control " name="sedeColegio" id="sedeColegio" data-toggle="">
                    <option selected disabled>Seleccione una opción</option>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <select required class="form-control " name="seccionColegio" id="seccionColegio" data-toggle="">
                    <option selected disabled>Seleccione una opción</option>
