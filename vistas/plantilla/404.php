                    ...
                    <div class="col-xxl-4 col-lg-5">
                        <div class="card">
                            ...
                            <div class="card-header pt-4 pb-4 text-center bg-primary">
                                <a href="index.html">
                                    <span><img src="recursos/assets/images/logo.png" alt="" height="18"></span>
                                </a>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-3">Parece que te has equivocado de camino. No te preocupes...
                                        Aquí hay un pequeño consejo que podría ayudarlo a volver a la normalidad.</p>
                                    <a class="btn btn-info mt-3" href="?"><i class="mdi mdi-reply"></i> Volver al Inicio</a>
                                </div>
                            </div> <!-- end card-body-->
                        </div>
                        <!-- end card -->
