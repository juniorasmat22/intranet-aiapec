                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php switch ($micuota->estadoCuota) {
                                                                ...
                                                                <?php break;
                                                                case '5': ?>
                                                                    <i class="mdi mdi-circle text-danger"></i> Rechazado
                                                                <?php break;
                                                                default: ?>

                                                                    <i class="mdi mdi-circle text-danger"></i> Sin estado
                                                            <?php break;
                                                            } ?>
                                                        </td>
                                                        <td>
                                                            <?php if ($micuota->estadoCuota=='1') {  ?>
                                                            ...
                                                            <?php } else { ?>
                                                                <a type="button" <?php echo "href='?c=pago&a=ver&idCuota=$micuota->idCuota'"; ?> class="btn btn-outline-info" ><i class="uil-money-insert"></i> Ver Pago</butaton>
                                                            <?php  }
                                                            ?>
