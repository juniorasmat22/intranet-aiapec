         ...
         <div class="page-title-box">
             <div class="page-title-right">
                 <ol class="breadcrumb m-0">
                     ...
                     <li class="breadcrumb-item active">Preuniversitarios</li>
                 </ol>
             </div>
             <h4 class="page-title">Programas Preuniversitarios</h4>
         </div>
     </div>
 </div>
 ...
 <div class="row">
     ...
     <?php
        if ($programas_pre->respuesta) {
            $filas = $programas_pre->resultado;
        ...
        ?>
         ...
         <div class="alert alert-warning" role="alert">
             <i class="dripicons-warning me-2"></i> No hay <strong>programas preuniversitarios</strong> disponibles
         </div>
     <?php
        }
        ?>
